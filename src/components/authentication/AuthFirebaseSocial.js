...
export default function AuthFirebaseSocials() {
  const { loginWithGoogle, loginWithFaceBook, loginWithTwitter, loginWithPhone } = useAuth();
  ...
  return (
    <>
      <Stack direction='row' spacing={2}>
        ...
        <Button fullWidth size='large' color='inherit' variant='outlined' onClick={loginWithPhone}>
          <Icon icon={phoneFill} color='grey' height={24} />
        </Button>
